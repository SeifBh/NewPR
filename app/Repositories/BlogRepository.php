...
class BlogRepository extends BaseRepository {
  ...
  if ($validator->fails()) {
    ...
    {
        return $this->model
            ->select('id', 'created_at', 'updated_at', 'title', 'slug', 'user_id', 'summary','path_file')
                        ->whereActive(true)
                        ->with('user')
                        ->latest();
    }
    ...
    {
        $query = $this->model
                ->select('posts.id', 'posts.created_at', 'title', 'posts.seen', 'active', 'user_id', 'slug', 'username','path_file')
