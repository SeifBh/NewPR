...
return [
    ...
    'new-messsage' => 'You have received a message from workwithTAG ADMIN',
    'new-reply' => 'You have received a message from workwithTAG ADMIN',
    'new-user' => 'From workwithTAG system to Admin'
