                    ...
                    <tr id="addr1"> 
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q1_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q2_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q3_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
             ...
             <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q4_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
               ...
               <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q5_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>                  
              ...
              <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q6_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
              ...
              <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q7_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
             ...
             <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q8_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
             ...
             <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                          ...
                          {{ Form::text('q9_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>
              ...
              <tr id="addr1">
                      ...
                      <td>
                        <div class="input-group">
                         ...
                         {{ Form::text('q10_answer5', null, ['class' => 'form-control']) }}
                        </div>
                      </td>
                    </tr>                                       
