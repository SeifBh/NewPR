...
<div class="">
    <div class="row clearfix">
        <div class="col-md-12 column">
         ...
         <tr id="addr1">
                      <td>
                        <textarea name="question1" type="text" placeholder="Question1" class="form-control input-md" ></textarea>
                      </td>
                      <td>
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question2" type="text" placeholder="question2" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question3" type="text" placeholder="question3" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question4" type="text" placeholder="question4" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question5" type="text" placeholder="question5" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question6" type="text" placeholder="question6" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question7" type="text" placeholder="question7" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question8" type="text" placeholder="question8" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question9" type="text" placeholder="question9" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
                    ...
                    <tr id="addr1">
                      <td>
                        <textarea name="question10" type="text" placeholder="question10" class="form-control input-md"  ></textarea>
                      </td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-addon beautiful">
