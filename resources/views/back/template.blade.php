            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    @if(session('statut') == 'admin')
                        ...
                        <li {!! classActiveSegment(1, 'Message') !!}>
                            <a href="#" data-toggle="collapse" data-target="#msgmenu"><span class="fa fa-fw fa-envelope"></span> Messages <span class="fa fa-fw fa-caret-down"></span></a>
                            <ul id="msgmenu" class="collapse">
                                <li><a href="{!! url('messages') !!}">New Message</a></li>
                                <li><a href="{!! url('contact') !!}">MailBox</a></li>
                                <li><a href="/contact/archive">Archive</a></li>
                            </ul>
                        </li>
                        ...
                        <li {!! classActivePath('Survey') !!}>
                            <a href="{!! url('surveys') !!}"><span class="fa fa-fw fa-question "></span>Surveys</a>
                        </li> 
