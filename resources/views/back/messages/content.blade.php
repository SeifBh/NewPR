...
@section('main')
		     	...
		     	<div class="row" style="margin:10px;">
					<div class="thumbnail">
						...
						<div class="container-fluid" style="margin:20px;">
							<div class="row">
								<pre><span class="pull-left" style="padding:15px;"><b>FROM : <u>{{$username}}</u></b></span>
                    ...
                    <div class="thubmnail">
                        ...
                        <div class="panel panel-primary">
                           ...
                           <?php echo '@';?>{{$username}} : {{ $reply->content }}
                    ...
                    <?php
            $user_check_last = DB::table('reply')->where('user_id','=',$user_id)
                                        ->where('msg_id','=',$msg_id)->orderBy('created_at', 'desc')->value('status');
        ...
        $last_reply = DB::table('reply')->where('user_id','=',$user_id)
                    ...
                    ?>
                    <div class="row" style="">
                    @if($user_check_last == 'admin')
                    <code class="pull-right">
                        @if($last_reply == '1') 
                        <i class="fa fa-eye" aria-hidden="true" style="color:green !important"></i> SEEN
                        @else
                    ...
                    <div class="thumbnail">
                        {!! Form::open(['action' => 'ContactController@ReplyAdminToUser', 'method' => 'post', 'role' => 'form']) !!} 
