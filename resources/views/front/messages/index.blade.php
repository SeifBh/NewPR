...
$( "#contentmessages" ).html('<center><i class="fa fa-spinner fa-spin fa-5x" aria-hidden="true" style="font-size:105px !important;"></i></center>' );
  ...
  $("#refreshMes").addClass('btn-warning');
    ...
    $.ajax({
            ...
            url:"http://workwithtag.theaccidentguys.co.uk/@<?php echo $slugname ;  ?>/messagesLOAD",
                 


        success:function(data,resultme){
...
@endif
 ...
 {!! Form::open(['action' => 'ContactController@hamham', 'method' => 'post', 'role' => 'form']) !!} 
<input type="hidden" name="id_messageme" value="{{$message->id}}">

<button class="btn btn-default" id="archivemes"> archive</button>
 {!! Form::close() !!}
